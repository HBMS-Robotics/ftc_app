...
public class BlueVufoia extends OpMode{
    ...
    public void init() {
        ...
        sm.addState(new DriveState("leftdrive", mh, 1050, "Lstrafe"));
        sm.addState(new SlideState("Lstrafe", mh, 475, "drive"));
        sm.addState(new WaitState("right", 2.0, "rightdrive"));
        sm.addState(new DriveState("rightdrive", mh, 1050, "Rrotate"));
        sm.addState(new Rotate_State("Rrotate", mh, 125, "RStrafe"));
